...
(function () {
  ...
  function buildFooter() {
    ...
    return [
      ...
      '        </a>',
      '        <a href="https://x.com/humanmirrorfyi" target="_blank" rel="noopener" class="hm-footer-social" aria-label="X (Twitter)">',
      ...
      '        </a>',
      '        <a href="https://www.youtube.com/@humanmirrorfyi" target="_blank" rel="noopener" class="hm-footer-social" aria-label="YouTube">',
